...
def params_x2x4(args):
    ...
    paths.save.exp_path = os.path.join(paths.save.save_path, f"{args.model_name}x2x4" + f"{args.extension}")
    ...
    training_config = ED()
    training_config.dataloader = 'x2x4Loader' #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    training_config.crop_size = 256
    training_config.num_workers = 16
    training_config.batch_size = 1 #考虑修改
...
#！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！
    ...
    validation_config.dataloader = 'x2x4Loader'
